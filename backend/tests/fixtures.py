...
class TestDataFixtures:
    ...
    def create_multiple_courses() -> List[Course]:
        return [
            TestDataFixtures.create_sample_course("Building Towards Computer Use with Anthropic"),
            TestDataFixtures.create_sample_course("MCP: Build Rich-Context AI Apps with Anthropic"),
            TestDataFixtures.create_sample_course("Advanced Retrieval for AI with Chroma")
        ]
    ...
    def create_course_metadata() -> List[Dict[str, Any]]:
        return [
            ...
            },
            {
                ...
                "lessons": [
                    {"lesson_number": 1, "lesson_title": "MCP Basics", "lesson_link": "https://example.com/mcp-lesson1"}
                ]
            }
        ]
