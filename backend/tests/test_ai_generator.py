...
class TestAIGenerator:
    ...
    def mock_tool_manager(self):
        ...
        mock_manager.execute_tool.return_value = (
            "Tool executed successfully with search results"
        )
        return mock_manager
    ...
    def test_generate_response_with_tools(
        ...
        result = ai_generator.generate_response(
            "What is in the course?", tools=tools, tool_manager=mock_tool_manager
        )
    ...
    def test_handle_tool_execution_multiple_tools(
        ...
        mock_tool_manager.execute_tool.assert_any_call(
            "search_course_content", query="query 1"
        )
        mock_tool_manager.execute_tool.assert_any_call(
    ...
    def test_response_without_tool_manager(self, ai_generator, mock_anthropic_client):
        ...
        result = ai_generator.generate_response(
            "What is in the course?", tools=tools, tool_manager=None  # No tool manager
        )
    ...
    def test_api_parameters_structure(self, ai_generator, mock_anthropic_client):
        ...
        ai_generator.generate_response(
            "Test query", conversation_history=conversation_history, tools=tools
        )
    ...
    def test_sequential_tool_failure_handling(
        self, ai_generator, mock_anthropic_client, mock_tool_manager
    ):
    ...
    def test_sequential_max_rounds_exceeded(
        self, ai_generator, mock_anthropic_client, mock_tool_manager
    ):
    ...
    def test_sequential_context_preservation(
        self, ai_generator, mock_anthropic_client, mock_tool_manager
    ):
