...
class TestVectorStore:
    ...
    def mock_embedding_function(self):
        ...
        with patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction') as mock_embedding:
            yield mock_embedding.return_value
    
    @pytest.fixture
    def vector_store(self, temp_chroma_path, mock_chroma_client, mock_embedding_function):
    ...
    def test_initialization(self, temp_chroma_path, mock_chroma_client, mock_embedding_function):
    ...
    def test_clear_all_data(self, vector_store):
        ...
        assert mock_client.get_or_create_collection.call_count >= 4  # 2 initial + 2 recreated
